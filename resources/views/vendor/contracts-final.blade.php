...
@section('page-title', 'Upload Kontrak')
@section('final-contract', 'active')
@section('address')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Upload Kontrak</li>
</ol>
@endsection
@push('styles')
<style>
...
<div>
    <div class="card">
        <div class="card-header card-forestgreen">
            <h6 class="card-title pt-1">Upload Kontrak</h6>
            ...
            <div class="table-responsive">
                <table id="pekerjaanTable" class="table table-sm table-hovered table-bordered table-hover table-striped datatable2">
                    ...
                    <tbody>
                        ...
                        @if($contract->vendor->userDetail->user_id == Auth::user()->userDetail->id)
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;"> <a href="{{ route('vendor.contract-final', ['contract' => $contract->contract_id, 'vendor' => $contract->vendor_id]) }}" class="btn btn-primary btn-xs"><b>Rincian</b></a>
                        </tr>
                        @endif
                        @endforeach
                    </tbody>
