            ...
            <div class="card-body">
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" value="{{ $contract->name }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="date" value="{{date('d/m/Y', strtotime($contract->created_at))}}" readonly>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table id="pekerjaanTable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center pr-0" style="vertical-align: middle; width: 10%;">Nilai Kontrak (Rp)</th>
                        ...
                        <tbody>
                            @foreach ($contract_vendor as $contract)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">{{ $contract->pivot->prosentase }}%</td>
